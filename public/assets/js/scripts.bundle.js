...
var KTAppAside = function () {
    ...
    return {
        init: function () {
            var n;
            (e = document.querySelector("#kt_aside"), t = document.querySelector("#kt_aside_menu_wrapper"), null !== e) && (t && (n = t.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(n, t) && t.scroll({
