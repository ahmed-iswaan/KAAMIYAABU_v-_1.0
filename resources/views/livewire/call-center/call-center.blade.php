<div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div wire:key="cc-modal-body-{{ $selectedDirectoryId ?? 'none' }}">
                                    ...
                                    <div class="card shadow-sm border border-gray-200 mb-6">
                                        ...
                                        <div class="card-body pt-2">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                                                ...
                                                <span class="badge badge-light fs-8">Manual save</span>
                                            </div>
                                                        ...
                                                        <div class="row g-3 align-items-end">
                                                            <div class="col-12 col-md-3">
                                                                ...
                                                                <select class="form-select form-select-sm" @disabled(!$activeElectionId || !count($phonesForAttemptsNorm))
                                                                        wire:model.defer="subStatusAttempts.{{ $a }}.phone_number">
                                                            ...
                                                            <div class="col-12 col-md-3">
                                                                ...
                                                                <select class="form-select form-select-sm" @disabled(!$activeElectionId)
                                                                        wire:model.defer="subStatusAttempts.{{ $a }}.sub_status_id">
                                                        ...
                                                        @if($activeElectionId)
                                                            <div class="mt-3 d-flex justify-content-end gap-2">
                                                                <button type="button" class="btn btn-sm btn-light-primary"
                                                                        wire:click="updateSubStatusAttemptStatus('{{ $a }}', $wire.subStatusAttempts['{{ $a }}']['sub_status_id'])"
                                    ...
                                    <div class="border rounded p-4">
                                        ...
                                        <div class="callcenter-dv-form" dir="rtl" lang="dv">
                                            <style>
                                                ...
                                                .callcenter-dv_form .form-control,.callcenter-dv-form .form-select{font-family:inherit;text-align:right; font-size: 15px;}
    ...
    {{-- Q2 (reason) - keep mounted to prevent focus loss --}}
