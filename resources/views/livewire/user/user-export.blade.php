        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form wire:submit.prevent="exportUsers" class="form">
                        <div class="text-center">
                            <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">Discard</button>
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">Export CSV</span>
                                <span wire:loading wire:target="exportUsers" class="indicator-progress">
                                    Please wait...
...
<script>
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('closeModal', () => {
            ...
            var modalElement = document.getElementById('kt_modal_export_users');
