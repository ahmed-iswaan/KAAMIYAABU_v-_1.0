                                ...
                                <div class="modal fade" id="kt_modal_remove_user" tabindex="-1" aria-hidden="true" wire:ignore.self>
                                    <!--begin::Modal dialog-->
                                    ...
                                    <div class="alert alert-dismissible bg-light-danger d-flex flex-center flex-column py-10 px-10 px-lg-20 mb-10">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="mb-9 text-gray-900">
                                                You are about to remove <strong>{{$editname}} ( {{$editstaff_id}} )</strong> from the system.

                                                ❌ All permissions and access rights will be revoked.

                                                🚫 This user will no longer be able to log into the portal.
                                ...
                                <script>
                                    ...
                                    waitForLivewire(() => {
                                        ...
                                        const modalElement = document.getElementById('kt_modal_remove_user');
